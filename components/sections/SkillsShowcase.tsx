    ...
    <section className="py-16 bg-muted/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              <Card className="h-full hover:shadow-xl transition-shadow">
                <CardHeader>
                  <CardTitle className={`bg-gradient-to-r ${category.color} text-transparent bg-clip-text`}>
                    {category.title}
                  </CardTitle>
                </CardHeader>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-3">
                {specializedSkills.map((skill, index) => (
                  ...
                  >
                    <Badge variant="secondary" className="text-sm py-2 px-4 cursor-default">
                      {skill}
                    </Badge>
                  </motion.div>
                ))}
        ...
        >
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <p className="text-4xl font-bold text-green-500 mb-2">8+</p>
              <p className="text-sm text-muted-foreground">Projects Delivered</p>
            </CardContent>
          </Card>
          <Card className="text-center">
            <CardContent className="pt-6">
              <p className="text-4xl font-bold text-orange-500 mb-2">5+</p>
