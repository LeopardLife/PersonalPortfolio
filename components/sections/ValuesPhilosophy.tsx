  ...
  return (
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Principles that guide my work and shape my approach to development
            </p>
          </div>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">My Development Approach</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A systematic, proven methodology refined through 15+ successful projects
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <Card className="pt-8">
                <CardContent>
                  <h3 className="text-xl font-bold mb-3 text-primary">{approach.problem}</h3>
            ...
            >
              ...
              <Card className="pt-8">
                <CardContent>
                  <h3 className="text-xl font-bold mb-3 text-purple-600">{approach.design}</h3>
                  <ul className="space-y-2">
            ...
            >
              ...
              <Card className="pt-8">
                <CardContent>
                  <h3 className="text-xl font-bold mb-3 text-green-600">{approach.implement}</h3>
                  <ul className="space-y-2">
                    {approach.implementSteps.map((step, i) => (
                      <li key={i} className="text-sm text-muted-foreground flex items-start gap-2">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg">
                4
              </div>
              <Card className="pt-8">
                <CardContent>
                  <h3 className="text-xl font-bold mb-3 text-orange-600">{approach.optimize}</h3>
                  <ul className="space-y-2">
                    {approach.optimizeSteps.map((step, i) => (
                      <li key={i} className="text-sm text-muted-foreground flex items-start gap-2">
