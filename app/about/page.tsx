			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						<div className="space-y-6">
							<div>
								...
								<p className="text-2xl font-semibold text-foreground mb-2">
									Fullstack Developer | 3D Web Applications
									Specialist
								</p>
								<p className="text-lg text-muted-foreground">
									Bridging Mechanical Engineering and Modern
									Web Development
								</p>
							</div>
							...
							<div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
								<p>
									...
									of specialized experience building scalable
									web applications with complex 3D
									visualizations and microservices
									architectures.
								</p>
								<p>
									Successfully delivered systems serving{" "}
									<span className="font-semibold text-foreground">
										more than 200 medical facilities across
										Canada
									</span>{" "}
									while reducing API response times by up to{" "}
								...
								<p>
									...
									with modern web development expertise to
									create intuitive 3D interfaces and robust
									backend systems using{" "}
									<span className="font-semibold text-foreground">
										Next.js, NestJS, Java Spring, and
										Three.js
									</span>
									.
								</p>
								<p>
									My unique journey from designing mechanical
									systems with SolidWorks to architecting
									complex web applications has given me a
									distinctive perspective on problem-solving
									and system design.
								</p>
							</div>
				...
				>
					...
					<p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
						Looking for a developer who combines technical expertise
						with a proven track record? Let's discuss your project.
					</p>
